 ...
 * See {@link ru.hse.shugurov.social_networks.AbstractRequester}
 * <p/>
 * Fragment requires following arguments:
 * <ul>
 * <li>topic id as String with a key specified by {@code TOPIC_ID_TAG}.</li>
 * <li>{@link ru.hse.shugurov.social_networks.SocialNetworkEntry[]} of comments with a key specified by {@code COMMENTS_TAG}.
 * Passed as parcelable array</li>
 * <li>{@link ru.hse.shugurov.social_networks.StateListener} with a key specified by {@code COMMENTS_LISTENER_TAG}.</li>
